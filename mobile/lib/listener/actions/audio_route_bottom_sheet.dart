...
class AudioRouteBottomSheet extends StatelessWidget {
  final AudioDeviceManager manager;

  const AudioRouteBottomSheet({super.key, required this.manager});

  static Future<void> show(BuildContext context, AudioDeviceManager manager) {
    return showModalBottomSheet(
      context: context,
      backgroundColor: Colors.transparent,
      builder: (_) => AudioRouteBottomSheet(manager: manager),
    );
  }
